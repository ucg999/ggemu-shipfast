  ...
  items: [
    {
      ...
      answer:
        '毎日のチェックイン、デイリーチャレンジ、通常ゲームのプレイ、ほかのプレイヤーの視聴、ページに現れるコインの回収で獲得できます。ホーム画面の移動コインは常に1コイン、内部ページのコインは1～10コインで、サイト全体で30分に1回現れます。通常ゲームは5分ごとに精算され、1回のプレイで最大100コインです。連続チェックインとランク倍率はプレイと視聴の報酬にのみ適用され、ページ上のコインには適用されません。アーケード麻雀モードは無料で、コインを消費しません。',
    },
    {

  ...
  items: [
    {
      question: '金币如何获得？',
      answer:
        '金币可以通过每日签到、完成今日挑战、游玩普通游戏、观看别人游玩，以及点击页面中出现的金币获得。首页的移动金币每次固定获得1个；内页金币每次随机获得1–10个，全站每30分钟出现一次。普通游戏按有效游玩时间结算金币，每满5分钟结算一次，每局最多获得100个；观看别人游玩也可以持续获得金币。连续签到和当前段位会提高“玩游戏、看别人玩”获得的金币倍数，但不会放大页面拾取金币。街机麻将模式免费游玩，不会扣除金币。',
    },
    {

...
export const zhCnMessages = {
  ...
  arcade: {
    ...
    flashMode: 'Flash游戏',
    flashTooltip: '经典Flash电脑游戏在线玩',
    flashTitle: 'Flash游戏',
    flashSubtitle: 'Flash 游戏依托 Adobe Flash 播放器运行，是 2000 至 2010 年风靡全网的网页小游戏。无需下载庞大客户端，打开浏览器网页就能直接游玩，操作轻便、加载迅速。闯关、射击、换装、经营、双人对战各类题材应有尽有，《闪客快打》《造梦西游》《拳皇 Flash》等作品承载一代人的上网回忆。凭借门槛低、玩法丰富、分享便捷的优势，曾撑起全网休闲游戏市场；后因安全漏洞与技术迭代淘汰，成为互联网早期游戏的独特怀旧符号。',
    allGames: '全部游戏',
    mostPopular: '最火游戏',
    gameInfo: '游戏信息',
    startGame: '开始游戏',

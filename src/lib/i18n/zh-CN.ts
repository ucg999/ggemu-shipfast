...
export const zhCnMessages = {
  ...
  home: {
    ...
    searchPlaceholder: '搜索我们的 {total} 款游戏',
    search: '搜索',
    reset: '重置',
    allPlatforms: '全部平台',
    allCategories: '全部分类',
    ...
    pspLibrary: 'PSP游戏目录表',
    psvLibrary: 'PSV游戏目录表',
    switchLibrary: 'Switch游戏目录表',
    arcadeLibrary: '街机库',
    popularGameLibrary: '热门游戏合集',
    mahjongSlots: '街机麻将',
    findFriends: '找点新朋友',
    wechat: '微信',
    wechatQrAlt: '怀旧游戏厅微信二维码',
    qqQrAlt: '怀旧游戏厅QQ二维码',
    kofCollection: '拳皇系列',
  ...
  homeSeo: {
    title: '怀旧游戏厅｜街机、小霸王FC、GBA经典游戏在线玩',
    description:
      '怀旧游戏厅收录街机、小霸王与FC、GBA、Flash等经典游戏，浏览器即点即玩，无需安装；另提供PSP、Switch游戏资料、截图与版本信息。',
    keywords:
      '怀旧游戏厅, 街机游戏在线玩, 小霸王游戏在线玩, FC游戏在线玩, GBA游戏在线玩, 经典游戏在线玩, 复古游戏在线玩, 浏览器免下载游戏, PSP游戏库, Switch游戏库',
  },
  arcade: {
    mode: '街机模式',
    tooltip: '经典街机游戏在线玩',
    seoTitle: '街机游戏在线玩｜经典街机游戏大全｜怀旧游戏厅',
    title: '街机游戏',
    ...
    famicomSeoTitle: '小霸王游戏在线玩｜FC红白机游戏大全｜怀旧游戏厅',
    famicomTitle: '小霸王游戏',
    ...
    gbaSeoTitle: 'GBA游戏在线玩｜Game Boy Advance游戏大全｜怀旧游戏厅',
    gbaTitle: 'GBA游戏',
    ...
    flashSeoTitle: '网页游戏在线玩｜Flash、HTML5与DOS游戏大全｜怀旧游戏厅',
    flashTitle: '网页游戏',
  ...
  items: [
    {
      question: '金币如何获得？',
      answer:
        '金币可以通过每日签到、完成今日挑战、游玩普通游戏、观看别人游玩，以及点击页面中出现的金币获得。首页的移动金币每次固定获得1个；内页金币每次随机获得1–10个，全站每30分钟出现一次。普通游戏按有效游玩时间结算金币，每满5分钟结算一次，每局最多获得100个；观看别人游玩也可以持续获得金币。连续签到和当前段位会提高“玩游戏、看别人玩”获得的金币倍数，但不会放大页面拾取金币。街机麻将为消耗金币的模式，每分钟扣1个金币，不会获得游玩金币。',
    },
    {

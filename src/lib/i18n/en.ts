...
export const enMessages = {
  layout: {
    ...
    theme: 'Theme',
    language: 'Language',
    copyright: 'Copyright © 2026 Retro Game Hall',
    get disclaimer() {
  ...
  home: {
    ...
    searchPlaceholder: 'Search all {total} games',
    search: 'Search',
    reset: 'Reset',
    ...
    pspLibrary: 'PSP Game Catalog',
    psvLibrary: 'PSV Game Catalog',
    switchLibrary: 'Switch Game Catalog',
    ...
    wechat: 'WeChat',
    wechatQrAlt: 'Retro Game Hall WeChat QR code',
    qqQrAlt: 'Retro Game Hall QQ QR code',
    kofCollection: 'The King of Fighters',
    streetFighterCollection: 'Street Fighter',
    retro8090Collection: '1988–1994 Arcade Classics',
  },
  homeSeo: {
    title: 'Retro Game Hall | Play Classic Arcade, NES and GBA Games Online',
    description:
      'Play classic Arcade, NES, SNES, GBA, PS1, N64 and Sega games in your browser with no installation. Browse separate PSP and Switch game information libraries.',
    keywords:
      'retro games online, arcade games online, play NES games online, play GBA games online, classic games online, browser games, no download games, PSP game library, Switch game library',
  },
  arcade: {
    mode: 'Arcade Mode',
    tooltip: 'Play classic arcade games online',
    seoTitle: 'Play Arcade Games Online | Classic Arcade Library | Retro Game Hall',
    title: 'Arcade Games',
    ...
    famicomSeoTitle: 'Play Famicom and NES Games Online | Retro Game Hall',
    ...
    gbaSeoTitle: 'Play GBA Games Online | Game Boy Advance Library | Retro Game Hall',
    gbaTitle: 'GBA Games',
    ...
    flashSeoTitle: 'Play Web Games Online | Flash, HTML5 and DOS | Retro Game Hall',
  ...
  about: {
    title: 'About',
    description: 'About Retro Game Hall, a browser-based classic games website.',
  },
  blog: {
    title: 'Retro Game Guides and Recommendations',
    description:
